...
class App extends React.PureComponent {
  ...
  //   selectProject = e => {
  //     // console.log('selectProject', e.target.value)
  //     this.setState({ activeRepo: e.target.value })
  //   }
  ...
  render() {
    ...
    // const { app, client, repos } = this.props
    // const {
    //   changeActiveIndex,
    //   closePanel,
    //   newIssue,
    ...
    // const issues = repos
    //   ? repos.map(repo => {
    //     repo.metadata.issues.forEach(issue => {
    //       issue.repo = repo.metadata.name
    //     })
    //     return repo.metadata.issues
    //   })
    //   : []
    // const flattenedIssues = [].concat.apply([], issues) // concat.apply flattens the issues
    ...
    return (
      <AragonApp publicUrl={ASSETS_URL}>
        ...
        {/* <AppContent
            app={app}
            projects={repos !== undefined ? repos : []}

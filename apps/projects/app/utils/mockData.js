          ...
          node: {
            ...
            refs: {
              edges: [
                ...
                {
                  node: {
                    name: '69-add-totalParticipation',
                    target: {
                      history: {
                        totalCount: 69,
                      },
                ...
                {
                  node: {
                    name: 'revert-50-21-vote-function',
                    target: {
                      history: {
                        totalCount: 67,
                      },

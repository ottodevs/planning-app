...
export const EMPTY_SCRIPT = '0x00000001'
...
export const encodeDelegate = addr => '0x00000002' + addr.slice(2) // remove 0x from addr
export const encodeDeploy = contract => '0x00000003' + contract.binary.slice(2)

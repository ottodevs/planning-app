...
module.exports = async (
  ...
  //   const ownerReceipt = await ens.setOwner(apmNode, owner)
  //   const ownerGet = await ens.owner(apmNode)

  // console.log('thew OWNER !', ens)
  //   console.log('thew OWNER !', theOwner)

  //   if (ownerReceipt === accounts[0]) {
